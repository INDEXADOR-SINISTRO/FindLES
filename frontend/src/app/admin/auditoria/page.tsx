...
const Auditoria = () => {
  ...
  const buscarAuditorias = async (paginaAtual: number, size: number, nomeOuEmail: string, dataDe: string, dataAte: string) => {
    try {
  ...
  useEffect(() => {
    buscarAuditorias(1, size, nomeOuEmail,dataDe,dataAte)
    setPaginaAtual(1)
  }, [size])
            ...
            <table className="w-full border-collapse text-center">
              ...
              <thead className="bg-[#E6E5DC] border-b border-[#c5c3b9]">
                <tr>
                  ...
                  <th className={auditorias.find(auditoria=>auditoria.logErro != "") ?  "p-4 border-r border-[#c5c3b9] text-[#4a4a4a] font-semibold w-2/5" : "hidden"}>
                    Erro
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                {auditorias.map((aud, index) => (
                  ...
                  >
                    ...
                    <td className={auditorias.find(auditoria=>auditoria.logErro != "") ? "p-4 border-r border-[#c5c3b9] text-[#f54b4b] text-xs" : "hidden"}>
                      {aud.logErro}
                    </td>
                  </tr>
                ))}
            ...
            <div className="flex justify-center items-center mt-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={() => {
                    buscarAuditorias(paginaAtual - 1, size, nomeOuEmail,dataDe,dataAte)
                ...
                <button
                  onClick={() => {
                    buscarAuditorias(totalPaginas, size, nomeOuEmail,dataDe,dataAte)
